...
export class WishlistController {
  ...
  async addToCart(@Body() body: { itemId: string; itemType: 'Course' | 'Product'; price: number; quantity?: number }, @Req() req) {
    return this.wishlistService.addToCart(req.user.id, body.itemId, body.itemType, body.price, body.quantity);
  }
