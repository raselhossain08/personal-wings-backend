...
export class Invoice extends Document {
  ...
  @ApiProperty({ enum: InvoiceStatus, example: InvoiceStatus.SENT, description: 'Invoice status' })
  ...
  @ApiProperty({ example: 'https://example.com/invoice.pdf', description: 'Invoice PDF URL' })
  @Prop()
  pdfUrl: string;
  ...
  @ApiProperty({ example: 'Payment terms: Net 30', description: 'Notes', required: false })
  @Prop()
  notes: string;
