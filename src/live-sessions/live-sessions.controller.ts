...
export class LiveSessionsController {
  ...
  async findAll(
    ...
    return this.liveSessionsService.findAll({ courseId, status, upcoming, page, limit });
  }
  ...
  async getMySessionsAsync(
    ...
    return this.liveSessionsService.getInstructorSessions(req.user.id, status, page, limit);
  }
  ...
  async update(@Param('id') id: string, @Body() updateSessionDto: UpdateLiveSessionDto, @Req() req) {
  ...
  async end(@Param('id') id: string, @Body('recordingUrl') recordingUrl: string, @Req() req) {
  ...
  async getCourseSessions(
    ...
    return this.liveSessionsService.getCourseSessions(courseId, upcoming, page, limit);
  }
}
