...
import { Assignment, AssignmentSubmission } from '../certificates/entities/additional.entity';
...
export class AssignmentsService {
  ...
  async getSubmission(id: string, userId: string): Promise<AssignmentSubmission> {
  ...
  async gradeSubmission(
    ...
    if (data.grade > assignment.maxPoints) {
      throw new BadRequestException(`Grade cannot exceed ${assignment.maxPoints} points`);
    }
