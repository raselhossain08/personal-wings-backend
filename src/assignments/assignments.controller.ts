...
export class AssignmentsController {
  ...
  async create(
    ...
    @Body() body: { title: string; description: string; dueDate: Date; maxPoints?: number; attachments?: string[] },
    @Req() req,
  ) {
  ...
  async getMySubmissions(
    ...
    return this.assignmentsService.getStudentSubmissions(req.user.id, courseId, page, limit);
  }
