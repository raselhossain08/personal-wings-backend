...
export class EnrollmentsController {
  ...
  async getMyEnrollments(
    ...
    return this.enrollmentsService.getUserEnrollments(req.user.id, status, page, limit);
  }
  ...
  async checkEnrollment(@Param('courseId') courseId: string, @Req() req) {
    const isEnrolled = await this.enrollmentsService.isEnrolled(courseId, req.user.id);
  ...
  async updateProgress(
    ...
    return this.enrollmentsService.updateProgress(courseId, updateProgressDto, req.user.id);
  }
