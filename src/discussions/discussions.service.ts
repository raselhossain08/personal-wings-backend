...
import { Discussion, DiscussionReply } from '../certificates/entities/additional.entity';

@Injectable()
export class DiscussionsService {
  constructor(
    @InjectModel(Discussion.name) private discussionModel: Model<Discussion>,
    @InjectModel(DiscussionReply.name) private replyModel: Model<DiscussionReply>,
  ) {}
  ...
  async markAsAnswer(id: string, discussionAuthorId: string): Promise<DiscussionReply> {
    ...
    if (discussion.author.toString() !== discussionAuthorId) {
      throw new ForbiddenException('Only the discussion author can mark answers');
    }
