...
export class SessionService {
  ...
  ): Promise<{ sessionToken: string; refreshToken: string; session: UserSession }> {
  ...
  async refreshSession(oldRefreshToken: string, sessionData: any): Promise<{ sessionToken: string; refreshToken: string }> {
  ...
  async revokeSession(sessionToken: string, reason: string = 'User initiated'): Promise<void> {
  ...
  async revokeAllUserSessions(userId: string, reason: string = 'Security policy'): Promise<number> {
  ...
  async getRecentFailedAttempts(email: string, hours: number = 1): Promise<number> {
