...
export class UserSession extends Document {
  ...
  @ApiProperty({ enum: SessionStatus, example: SessionStatus.ACTIVE, description: 'Session status' })
  ...
  @ApiProperty({ example: '2024-01-15T10:30:00.000Z', description: 'Last activity timestamp' })
  @Prop({ default: Date.now })
  lastActivity: Date;

  @ApiProperty({ example: '2024-02-15T10:30:00.000Z', description: 'Expires at' })
  @Prop({ required: true })
  expiresAt: Date;
  ...
  @ApiProperty({ example: 'User logged out', description: 'Revocation reason', required: false })
  @Prop()
