...
import { IsEmail, IsNotEmpty, IsString, MinLength, IsOptional, IsEnum, IsArray, IsNumber } from 'class-validator';
...
export class CreateUserDto {
  ...
  @ApiProperty({ example: 'Pilot with 10+ years experience', description: 'Bio', required: false })
  @IsOptional()
  @IsString()
  bio?: string;

  @ApiProperty({ example: ['ATP', 'CFI'], description: 'Certifications', required: false })
  @IsOptional()
  @IsArray()
  certifications?: string[];

  @ApiProperty({ example: 1500, description: 'Total flight hours', required: false })
  @IsOptional()
  @IsNumber()
  flightHours?: number;
}