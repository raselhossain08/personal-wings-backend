...
export class Message extends Document {
  ...
  @ApiProperty({ example: ['user1', 'user2'], description: 'Read by user IDs', required: false })
  @Prop([{ type: Types.ObjectId, ref: 'User' }])
  readBy: Types.ObjectId[] | User[];

  @ApiProperty({ example: 'file.pdf', description: 'File URL for file messages', required: false })
  @Prop()
  fileUrl: string;

  @ApiProperty({ example: 'image.jpg', description: 'Image URL for image messages', required: false })
  @Prop()
  imageUrl: string;
  ...
  @ApiProperty({ example: 'message_123', description: 'Reply to message ID', required: false })
