...
export class ChatController {
  ...
  async createConversation(@Body() createConversationDto: CreateConversationDto, @Req() req) {
  ...
  async sendMessage(
    ...
    return this.chatService.sendMessage(conversationId, createMessageDto, req.user.id);
  }
