...
export class CreateOrderDto {
  ...
  @ApiProperty({ type: Object, description: 'Billing address', required: false })
  @IsObject()
  @IsOptional()
  billingAddress?: {
    firstName: string;
  ...
  @ApiProperty({ example: 'affiliate_123', description: 'Affiliate ID', required: false })
  @IsString()
  @IsOptional()
  affiliate?: string;

  @ApiProperty({ example: 100, description: 'Affiliate commission', required: false })
  @IsNumber()
  @Min(0)
  @IsOptional()
