...
export class Order extends Document {
  ...
  @ApiProperty({ enum: PaymentMethod, example: PaymentMethod.STRIPE, description: 'Payment method' })
  @Prop({ type: String, enum: PaymentMethod })
  paymentMethod: PaymentMethod;

  @ApiProperty({ example: 'pi_1ABC123def456', description: 'Payment intent ID', required: false })
  @Prop()
  paymentIntentId: string;

  @ApiProperty({ example: 'ch_1ABC123def456', description: 'Charge ID', required: false })
  @Prop()
  chargeId: string;

  @ApiProperty({ example: '2024-01-15T10:30:00.000Z', description: 'Payment date', required: false })
  @Prop()
  paidAt: Date;

  @ApiProperty({ example: 'INV-2024-001', description: 'Invoice number', required: false })
  @Prop()
  invoiceNumber: string;

  @ApiProperty({ example: 'https://example.com/invoice.pdf', description: 'Invoice URL', required: false })
  @Prop()
  invoiceUrl: string;
  ...
  @ApiProperty({ example: 'Customer requested refund', description: 'Cancellation reason', required: false })
  @Prop()
