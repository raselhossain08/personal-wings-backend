...
export class AttendanceController {
  ...
  markAttendance(@Body() markAttendanceDto: MarkAttendanceDto, @Req() req) {
    return this.attendanceService.markAttendance(markAttendanceDto, req.user.userId, req);
  }
  ...
  getUserAttendance(
    ...
    return this.attendanceService.getUserAttendance(req.user.userId, { courseId, present });
  }
  ...
  getAttendanceReport(
    ...
    return this.attendanceService.getAttendanceReport({ startDate, endDate, courseId });
  }
