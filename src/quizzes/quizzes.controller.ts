...
export class QuizzesController {
  ...
  async getMySubmissions(
    ...
    return this.quizzesService.getUserSubmissions(req.user.id, quizId, page, limit);
  }
  ...
  async update(@Param('id') id: string, @Body() updateQuizDto: UpdateQuizDto, @Req() req) {
  ...
  async submitQuiz(
    ...
    return this.quizzesService.submitQuiz(id, submissionId, submitQuizDto, req.user.id);
  }
