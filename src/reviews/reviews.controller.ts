...
export class ReviewsController {
  ...
  @ApiResponse({ status: 200, description: 'Review marked/unmarked as helpful' })
  ...
  async reply(@Param('id') id: string, @Body() replyDto: ReplyReviewDto, @Req() req) {
    return this.reviewsService.replyToReview(id, replyDto.replyText, req.user.id);
  }
  ...
  async getStats(@Param('itemId') itemId: string, @Query('type') type: ReviewType) {
